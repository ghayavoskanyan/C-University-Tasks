/* Սահմանել դաս,որի պաշտպանված անդամներն են 1. Կառուցվածք տիպի զանգվածի ցուցիչը/ կառուցվածքի դաշտերն են ա/ ազգանուն, բ/ թոշակ գ/ ստաժ / 2. այդ զանգվածի տարրերի քանակը:Այս դասի համար սահմանել բաց ժառանգ դաս, որի բաց ֆունկցիաներից մեկը ստանում և արտածում է տրված թվից շատ թոշակ ստացողների  ցուցակը:Պահանջվում է ժառանգ դասի օբյեկտի միջոցով  արտածել տրված թվից շատ թոշակ ստացողների  ցուցակը: */
#include <iostream>
#include <cstring>
